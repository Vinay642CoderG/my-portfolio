export const projects = [
  {
    ...
    description:
      'Full-stack blogging platform with JWT authentication, REST APIs, content management, comments, and AI-powered content suggestions.',
    category: 'AI/ML',
    technologies: ['React.js', 'Node.js', 'Express.js', 'MongoDB', 'JWT', 'AI Integration'],
    github: 'https://github.com/Vinay642CoderG/Blogify-MERN',
    featured: true,
    color: 'violet',
  },
  {
    ...
    description:
      'Full-stack e-commerce application with product management, shopping cart, checkout, authentication, order processing, and product recommendations.',
    category: 'Web',
  ...
  },
  {
    ...
    category: 'AI/ML',
    image: `${import.meta.env.BASE_URL}ats_preview1.png`,
